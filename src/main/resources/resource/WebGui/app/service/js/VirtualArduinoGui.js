angular.module('mrlapp.service.VirtualArduinoGui', [])
        .controller('VirtualArduinoGuiCtrl', ['$scope', '$log', 'mrl', '$timeout', function ($scope, $log, mrl, $timeout) {
                $log.info('VirtualArduinoGuiCtrl');
                var _self = this;
                var msg = this.msg;
