...
public class TestPhysicsHingeJoint extends SimpleApplication implements AnalogListener {
  ...
  public void setupJoint() {
    ...
    joint = new HingeJoint(holderNode.getControl(RigidBodyControl.class), hammerNode.getControl(RigidBodyControl.class), Vector3f.ZERO, new Vector3f(0f, -1, 0f), Vector3f.UNIT_Z,
        Vector3f.UNIT_Z);
